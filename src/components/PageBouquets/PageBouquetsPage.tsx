...
const CHANNEL_CACHE_KEY =
  "ulka_pagebouquets_channels_v1";

const BOUQUET_CACHE_KEY =
  "ulka_pagebouquets_bouquets_v1";
...
const fetchChannels =
  async (): Promise<Channel[]> => {
    ...
    const result =
      (await response.json()) as ChannelApiResult;
    ...
    if (
      ...
      throw new Error(
        result.message ||
          `Failed to fetch channels (${response.status})`
      );
    }
...
const fetchBouqueData =
  ...
  > => {
    ...
    const result =
      (await response.json()) as BouquetApiResult;
    ...
    if (
      ...
      throw new Error(
        result.message ||
          `Failed to fetch bouquet data (${response.status})`
      );
    }
    ...
    useEffect(() => {
      ...
      const loadData =
        async () => {
          ...
          const cachedBouquets =
            readCache<BouqueItem[]>(
              BOUQUET_CACHE_KEY
            );
          ...
          console.log(
            "🚀 Starting background ULKA refresh..."
          );
          ...
          if (
            ...
            if (
              ...
              setChannelError(
                channelResult.reason instanceof
                  Error
          ...
          if (
            ...
            console.error(
              "Bouquets refresh failed:",
              bouquetResult.reason
            );
            ...
            if (
              ...
              setBouquetError(
                bouquetResult.reason instanceof
                  Error
          ...
          console.log(
            "✅ ULKA background refresh completed."
          );
        };
      ...
      <div className="p-4 sm:p-10 md:p-20 mt-[2rem] bg-white text-black min-h-screen">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mb-6">
            View all channels and
            broadcaster packs
            available on ULKA TV
          </p>
          ...
          {/* ==================================================
              SMALL BACKGROUND REFRESH INDICATOR
          ================================================== */}
              ...
              channels.length ===
                ...
                <div className="w-full max-w-5xl mb-6 rounded-md border border-red-300 bg-red-50 p-5 text-red-700">
                  ...
                  <p className="text-xs mt-3">
                    Please login again if your
                    ULKA session has expired.
                  </p>
              ...
              categories.map(
                (
                  ...
                  <div
                    ...
                    className="w-full max-w-8xl mb-4"
                  >
