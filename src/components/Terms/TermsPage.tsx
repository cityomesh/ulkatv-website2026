...
const faqData: FAQItem[] = [
    ...
    {
        id: "q3",
        question: "Cannot connect to network (Wi-Fi)",
        answer: "Check your internet connection. Ensure your Wi-Fi password is correct. Restart your router and try reconnecting.",
    },
    {
        id: "q4",
        question: "Cannot connect to network (Ethernet)",
        answer: "Verify the Ethernet cable is securely connected to both the smart box and your router. Check if the network port is active and try restarting your router.",
    },
    {
        id: "q5",
    ...
    {
        id: "q6",
        question: "Audio but no video on TV",
        answer: "Check if the HDMI cable is properly connected. Try using a different HDMI port on your TV. Restart both the smart box and your TV.",
    },
];
