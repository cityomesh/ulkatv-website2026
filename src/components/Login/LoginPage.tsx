...
const Login = () => {
  ...
  useEffect(() => {
    // Token already hardcoded — direct ga bouquets page ki vellu
    router.replace("/pagebouquets");
  }, [router]);

  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-900">
      <p className="text-white">Redirecting to plans...</p>
    </div>
  );
};
